...
const LoadingSpinner = (props: { size?: number }) => {
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className="animate-spin fill-purple-600 text-gray-200 dark:text-gray-600"
        viewBox="0 0 100 101"
        fill="none"
        ...
        <div className="p-6">
          <div className="relative rounded-xl border border-purple-600 bg-gradient-to-br from-[#9c6ae3] to-[hsl(280,100%,70%)] p-10">
            <Image
              src="/images/dad.png"
              alt="Profile image"
              className="bd absolute -top-8 -left-8 border-spacing-4 rounded-full border-2 border-teal-200 bg-teal-500 p-2"
              width={80}
              height={80}
            />
            <div className="text-l flex items-center space-x-4 whitespace-pre-wrap font-bold text-white">
              {answer}
            </div>
          </div>
        </div>
